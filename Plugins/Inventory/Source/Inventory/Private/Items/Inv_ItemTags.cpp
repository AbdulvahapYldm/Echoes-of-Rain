...
namespace GameItems
{
	namespace Equipment
	{
		...
		namespace Cloaks
		{
			UE_DEFINE_GAMEPLAY_TAG_COMMENT(RedCloaks, "GameItems.Equipment.Cloaks.RedCloaks", "RedCloaks")
		}
		namespace Masks
		{
	...
	namespace Craftables
	{
		...
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(LumenDais, "GameItems.Craftables.LumenDais", "LumenDais")
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ScorchPetalBlosrom, "GameItems.Craftables.ScorchPetalBlosrom", "ScorchPetalBlosrom")
